    ...
    (function (Renderers) {
        ...
        (function (Mocks) {
            ...
            function IsPhone(name) {
                var nameInLower = name.toLowerCase().replace(/_/g, "");
                return ((nameInLower.indexOf("phone") != -1)); //for now don't know any other common situations to use this
            }
            function IsEmail(name) {
                var nameInLower = name.toLowerCase().replace(/_/g, "");
                return ((nameInLower.indexOf("mail") != -1)); //for now don't know any other common situations to use this
            }

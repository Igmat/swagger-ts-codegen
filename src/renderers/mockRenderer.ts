...
export namespace Mocks {
    ...
    class PropertyViewWrapper {
        ...
        constructor(property: Generators.ModelGeneration.PropertyView) {
    ...
    class ModelViewWrapper {
        ...
        constructor(model: Generators.ModelGeneration.ModelView) {
    ...
    class ChanceViewWrapper {
        ...
        constructor(models: Generators.ModelGeneration.ModelViewCollection, enums?: Generators.EnumGeneration.EnumViewCollection) {
            this.models = [];
    ...
    class ParameterViewWrapper {
        ...
        constructor(parameter: Generators.ServiceGeneration.ParameterView) {
    ...
    class MethodViewWrapper {
        ...
        constructor(method: Generators.ServiceGeneration.MethodView) {
    ...
    class ServiceViewWrapper {
        ...
        constructor(service: Generators.ServiceGeneration.ServiceView) {
    ...
    export class MockRenderer {
        ...
        public RenderChanceHelper(models: Generators.ModelGeneration.ModelViewCollection, enums: Generators.EnumGeneration.EnumViewCollection): string {
            return Mustache.render(this.chanceTemplate, new ChanceViewWrapper(models, enums));
        }

        public RenderChanceHelperOverride(models: Generators.ModelGeneration.ModelViewCollection): string {
            return Mustache.render(this.chanceOverrideTemplate, new ChanceViewWrapper(models));
        }

        public RenderMockContent(serviceView: Generators.ServiceGeneration.ServiceView): string {
            return Mustache.render(this.mockTemplate, new ServiceViewWrapper(serviceView));
        }

        public RenderMockContentOverride(serviceView: Generators.ServiceGeneration.ServiceView): string {
            return Mustache.render(this.mockOverrideTemplate, new ServiceViewWrapper(serviceView));
        }

        public RenderMock(component: Generators.ServiceGeneration.Component): RenderedMock {
        ...
        public RenderMocks(components: Generators.ServiceGeneration.Component[]): RenderedMock[] {
